...
public class Color extends Elemento {
    ...
    public Elemento complemento(){
        ...
        Elemento nuevoColor = new Color(r,b,g);
        return nuevoColor;
    }
    public boolean equals(Elemento e){
        ...
        if(this != e && e != null){
            Color c = (Color) e;
            res = this.rojo == c.obtenerRojo() && this.azul == c.obtenerAzul() && this.verde == c.obtenerVerde();
        }

        return res;
    }
    public Elemento clone(){
        Elemento nuevoColor = new Color(this.rojo, this.azul, this.verde);
        return nuevoColor;
    }
